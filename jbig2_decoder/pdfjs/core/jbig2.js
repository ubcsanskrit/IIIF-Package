...
var Jbig2Image = (function Jbig2ImageClosure() {
  ...
  function processSegments(segments) {
    ...
    for(i = 0; i < numSegments; i++) {
      ...
      if (segment.header.typeName == "EndOfPage") {
        output.push({
          buffer: visitor.buffer,
          currentPageInfo: visitor.currentPageInfo,
          pageAssociation: segment.header.pageAssociation
        });
      }
    }
    return output;
  ...
  Jbig2Image.prototype = {
    ...
    parseJbig2: function Jbig2Image_parseJbig2(data, start, end) {
      return parseJbig2(data, start, end);
    }
  };
